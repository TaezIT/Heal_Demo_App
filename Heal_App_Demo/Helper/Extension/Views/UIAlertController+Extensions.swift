...
extension UIAlertController {
    ...
    class func messageAlert(title: String, message: String? = nil, cancelTitle: String = "Done", preferredStyle: UIAlertController.Style) -> UIAlertController {
    ...
    class func agreeAlert(title: String, message: String? = nil, cancelTitle: String = "Cannel", agreeTitle: String = "Agree", agreeHandler: ((UIAlertAction) -> Void)?, preferredStyle: UIAlertController.Style) -> UIAlertController {
        
        let alert = UIAlertController(title: title, message: message, preferredStyle: preferredStyle)
        alert.addAction(UIAlertAction(title: cancelTitle, style: .default, handler: nil))
        alert.addAction(UIAlertAction(title: agreeTitle, style: .cancel, handler: agreeHandler))
        return alert
    }
}
